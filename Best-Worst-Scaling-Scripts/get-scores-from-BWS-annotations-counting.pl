...
#
#  Usage: get-scores-from-BWS-annotations-counting.pl <file-annotations> <output-file>
...
#    The output is written into <output-file>. 
#  
...
die "Usage: get-scores-from-BWS-annotations-counting.pl <file-annotations> <output-file>\n" if(@ARGV < 1);
